...
namespace Yahtzee.Web
{
    class Dice
    {
        ...
        public int CalcX(int dieValue, int[] diceValue)
        {
            int total = 0;

            for (int i = 0; i < diceValue.Length; i++)
            {
                if (diceValue[i] == dieValue)
                {
                    total += diceValue[i];
                }
            }
        ...
        public int CalcXOfAKind(int numOfAKind, int[] diceValue)
        {
            int total = 0;
            int counter = 1;
        ...
        public int CalcFullHouse(int[] diceValue)
        {
        ...
        public int CalcStraight(bool wantLargeStraight, int[] diceValue)
        {
            int total = 0;
        ...
        public int CalcChance(int[] diceValue)
        {
            int total = 0;
